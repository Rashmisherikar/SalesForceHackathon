...
public class TC18 extends BrowserUtility{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement OpportunitiesPipeLineUnderReport = driver.findElement(By.xpath("//table[@id='toolsContent']//tr[1]//td[1]//div[contains(@class,'toolsContentLeft')]//li/a[contains(text(),'Stuck Opportunities')]"));
